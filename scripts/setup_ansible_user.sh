...
for SERVER in "${SERVERS[@]}"; do
    ...
    echo "$SUDO_PASS" | sudo -S ssh -t "$SUDO_USER@$SERVER" <<EOF
        ...
        # Creating SSH directory for the user
        ...
        # Adding the SSH public key to authorized_keys (replace with your public key)
        ...
        # Ensuring the correct ownership of the SSH directory
